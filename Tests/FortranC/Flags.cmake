set(src "/content/CMake/Tests/FortranC")
set(bld "/content/CMake/Tests/FortranC/Flags")
...
execute_process(
  ...
  COMMAND ${CMAKE_COMMAND} "${src}" -G "Unix Makefiles"
                           ...
                           "-DCMAKE_C_FLAGS:STRING= -Wcast-align -Werror-implicit-function-declaration -Wchar-subscripts -Wall -W -Wpointer-arith -Wwrite-strings -Wformat-security -Wmissing-format-attribute -fno-common -Wundef"
