file(REMOVE_RECURSE "/content/CMake/Tests/CMakeTests/uploads")

if(EXISTS "/content/CMake/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/content/CMake/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/content/CMake/Tests/CMakeTests/uploads")

set(filename "/content/CMake/Tests/CMakeTests/FileDownloadInput.png")
if(NOT "/content/CMake/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/content/CMake/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/content/CMake/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/content/CMake/Tests/CMakeTests/uploads/file2.png"
